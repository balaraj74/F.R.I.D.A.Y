...
<p align="center">
  <img src="https://raw.githubusercontent.com/friday/friday/main/docs/whatsapp-friday.jpg" alt="FRIDAY" width="400">
</p>
...
<p align="center">
  <a href="https://github.com/friday/friday/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/friday/friday/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/friday/friday/releases"><img src="https://img.shields.io/github/v/release/friday/friday?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://deepwiki.com/friday/friday"><img src="https://img.shields.io/badge/DeepWiki-friday-111111?style=for-the-badge" alt="DeepWiki"></a>
  <a href="https://discord.gg/friday"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**FRIDAY** is a *personal AI assistant* you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://friday.ai) · [Docs](https://docs.friday.ai) · [Getting Started](https://docs.friday.ai/start/getting-started) · [Updating](https://docs.friday.ai/install/updating) · [Showcase](https://docs.friday.ai/start/showcase) · [FAQ](https://docs.friday.ai/start/faq) · [Wizard](https://docs.friday.ai/start/wizard) · [Nix](https://github.com/friday/nix-friday) · [Docker](https://docs.friday.ai/install/docker) · [Discord](https://discord.gg/friday)

Preferred setup: run the onboarding wizard (`friday onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.friday.ai/start/getting-started)

**Subscriptions (OAuth):**
- **[Anthropic](https://www.anthropic.com/)** (Claude Pro/Max)
- **[OpenAI](https://openai.com/)** (ChatGPT/Codex)

Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.5** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.friday.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.friday.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.friday.ai/concepts/model-failover)
...
Legacy note: `friday` remains available as a compatibility shim.

## Quick start (TL;DR)

Runtime: **Node ≥22**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.friday.ai/start/getting-started)

```bash
friday onboard --install-daemon

friday gateway --port 18789 --verbose

# Send a message
friday message send --to +1234567890 --message "Hello from FRIDAY"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
friday agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.friday.ai/install/updating) (and run `friday doctor`).
...
Switch channels (git + npm): `friday update --channel stable|beta|dev`.
Details: [Development channels](https://docs.friday.ai/install/development-channels).
...
Note: `pnpm friday ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `friday` binary.

## Security defaults (DM access)

FRIDAY connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.friday.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:
- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `friday pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `friday doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.friday.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.friday.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, BlueBubbles, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.friday.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.friday.ai/nodes/voicewake) + [Talk Mode](https://docs.friday.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.friday.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.friday.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.friday.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.friday.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.friday.ai/nodes).
- **[Onboarding](https://docs.friday.ai/start/wizard) + [skills](https://docs.friday.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=friday/friday&type=date&legend=top-left)](https://www.star-history.com/#friday/friday&type=date&legend=top-left)

## Everything we built so far

### Core platform
- [Gateway WS control plane](https://docs.friday.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.friday.ai/web), and [Canvas host](https://docs.friday.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.friday.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.friday.ai/start/wizard), and [doctor](https://docs.friday.ai/gateway/doctor).
- [Pi agent runtime](https://docs.friday.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.friday.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.friday.ai/concepts/groups).
- [Media pipeline](https://docs.friday.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.friday.ai/nodes/audio).

### Channels
- [Channels](https://docs.friday.ai/channels): [WhatsApp](https://docs.friday.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.friday.ai/channels/telegram) (grammY), [Slack](https://docs.friday.ai/channels/slack) (Bolt), [Discord](https://docs.friday.ai/channels/discord) (discord.js), [Google Chat](https://docs.friday.ai/channels/googlechat) (Chat API), [Signal](https://docs.friday.ai/channels/signal) (signal-cli), [iMessage](https://docs.friday.ai/channels/imessage) (imsg), [BlueBubbles](https://docs.friday.ai/channels/bluebubbles) (extension), [Microsoft Teams](https://docs.friday.ai/channels/msteams) (extension), [Matrix](https://docs.friday.ai/channels/matrix) (extension), [Zalo](https://docs.friday.ai/channels/zalo) (extension), [Zalo Personal](https://docs.friday.ai/channels/zalouser) (extension), [WebChat](https://docs.friday.ai/web/webchat).
- [Group routing](https://docs.friday.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.friday.ai/channels).

### Apps + nodes
- [macOS app](https://docs.friday.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.friday.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.friday.ai/nodes/talk) overlay, [WebChat](https://docs.friday.ai/web/webchat), debug tools, [remote gateway](https://docs.friday.ai/gateway/remote) control.
- [iOS node](https://docs.friday.ai/platforms/ios): [Canvas](https://docs.friday.ai/platforms/mac/canvas), [Voice Wake](https://docs.friday.ai/nodes/voicewake), [Talk Mode](https://docs.friday.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.friday.ai/platforms/android): [Canvas](https://docs.friday.ai/platforms/mac/canvas), [Talk Mode](https://docs.friday.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.friday.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation
- [Browser control](https://docs.friday.ai/tools/browser): dedicated friday Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.friday.ai/platforms/mac/canvas): [A2UI](https://docs.friday.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.friday.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.friday.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.friday.ai/automation/cron-jobs); [webhooks](https://docs.friday.ai/automation/webhook); [Gmail Pub/Sub](https://docs.friday.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.friday.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety
- [Channel routing](https://docs.friday.ai/concepts/channel-routing), [retry policy](https://docs.friday.ai/concepts/retry), and [streaming/chunking](https://docs.friday.ai/concepts/streaming).
- [Presence](https://docs.friday.ai/concepts/presence), [typing indicators](https://docs.friday.ai/concepts/typing-indicators), and [usage tracking](https://docs.friday.ai/concepts/usage-tracking).
- [Models](https://docs.friday.ai/concepts/models), [model failover](https://docs.friday.ai/concepts/model-failover), and [session pruning](https://docs.friday.ai/concepts/session-pruning).
- [Security](https://docs.friday.ai/gateway/security) and [troubleshooting](https://docs.friday.ai/channels/troubleshooting).

### Ops + packaging
- [Control UI](https://docs.friday.ai/web) + [WebChat](https://docs.friday.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.friday.ai/gateway/tailscale) or [SSH tunnels](https://docs.friday.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.friday.ai/install/nix) for declarative config; [Docker](https://docs.friday.ai/install/docker)-based installs.
- [Doctor](https://docs.friday.ai/gateway/doctor) migrations, [logging](https://docs.friday.ai/logging).
...
- **[Gateway WebSocket network](https://docs.friday.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.friday.ai/gateway)).
- **[Tailscale exposure](https://docs.friday.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.friday.ai/gateway/remote)).
- **[Browser control](https://docs.friday.ai/tools/browser)** — friday‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.friday.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.friday.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.friday.ai/nodes/voicewake) + [Talk Mode](https://docs.friday.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.friday.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

FRIDAY can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
Notes:
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (FRIDAY enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.friday.ai/gateway/tailscale) · [Web surfaces](https://docs.friday.ai/web)
...
Details: [Remote access](https://docs.friday.ai/gateway/remote) · [Nodes](https://docs.friday.ai/nodes) · [Security](https://docs.friday.ai/gateway/security)
...
Details: [Nodes](https://docs.friday.ai/nodes) · [macOS app](https://docs.friday.ai/platforms/macos) · [Gateway protocol](https://docs.friday.ai/concepts/architecture)
...
Details: [Session tools](https://docs.friday.ai/concepts/session-tool)
...
- Controlled via `friday nodes …`.

Runbook: [iOS connect](https://docs.friday.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.friday.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/friday` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/friday/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.friday/friday.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.friday.ai/gateway/configuration)
...
Details: [Security guide](https://docs.friday.ai/gateway/security) · [Docker + sandboxing](https://docs.friday.ai/install/docker) · [Sandbox config](https://docs.friday.ai/gateway/configuration)

### [WhatsApp](https://docs.friday.ai/channels/whatsapp)

- Link the device: `pnpm friday channels login` (stores creds in `~/.friday/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.friday.ai/channels/telegram)
...
### [Slack](https://docs.friday.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.friday.ai/channels/discord)
...
### [Signal](https://docs.friday.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [iMessage](https://docs.friday.ai/channels/imessage)

- macOS only; Messages must be signed in.
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.friday.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.friday.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.friday.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.friday.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.friday.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.friday.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.friday.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.friday.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.friday.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.friday.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.friday.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.friday.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.friday.ai/platforms/windows), [Linux](https://docs.friday.ai/platforms/linux), [macOS](https://docs.friday.ai/platforms/macos), [iOS](https://docs.friday.ai/platforms/ios), [Android](https://docs.friday.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.friday.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.friday.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.friday.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.friday.ai/gateway/bonjour)
- [Gateway pairing](https://docs.friday.ai/gateway/pairing)
- [Remote gateway README](https://docs.friday.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.friday.ai/web/control-ui)
- [Dashboard](https://docs.friday.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.friday.ai/gateway/health)
- [Gateway lock](https://docs.friday.ai/gateway/gateway-lock)
- [Background process](https://docs.friday.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.friday.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.friday.ai/logging)

## Deep dives

- [Agent loop](https://docs.friday.ai/concepts/agent-loop)
- [Presence](https://docs.friday.ai/concepts/presence)
- [TypeBox schemas](https://docs.friday.ai/concepts/typebox)
- [RPC adapters](https://docs.friday.ai/reference/rpc)
- [Queue](https://docs.friday.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.friday.ai/tools/skills-config)
- [Default AGENTS](https://docs.friday.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.friday.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.friday.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.friday.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.friday.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.friday.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.friday.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.friday.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.friday.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.friday.ai/platforms/mac/voicewake)
- [iOS node](https://docs.friday.ai/platforms/ios)
- [Android node](https://docs.friday.ai/platforms/android)
- [Windows (WSL2)](https://docs.friday.ai/platforms/windows)
- [Linux app](https://docs.friday.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.friday.ai/gmail-pubsub](https://docs.friday.ai/automation/gmail-pubsub)

## Molty

FRIDAY was built for **Molty**, a space lobster AI assistant. 🤖
by Peter Steinberger and the community.

- [friday.me](https://friday.me)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@friday](https://x.com/friday)
