...
# Output:
# - dist/FRIDAY.app
# - dist/FRIDAY-<version>.zip
# - dist/FRIDAY-<version>.dmg
...
ZIP="$ROOT_DIR/dist/FRIDAY-$VERSION.zip"
DMG="$ROOT_DIR/dist/FRIDAY-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/FRIDAY-$VERSION.notary.zip"
