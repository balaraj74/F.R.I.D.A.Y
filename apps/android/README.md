## FRIDAY Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_friday-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm friday gateway --port 18789 --verbose
```
