...
final class ScreenController {
    ...
    /// Callback invoked when a friday:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = FRIDAYKitResources.bundle
...
/// Handles navigation policy to intercept friday:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept friday:// deep links
        if url.scheme == "friday" {
