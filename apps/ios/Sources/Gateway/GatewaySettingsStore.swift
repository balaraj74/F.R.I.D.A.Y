...
enum GatewaySettingsStore {
    ...
    private static let legacyGatewayService = "com.friday.gateway"
    private static let legacyBridgeService = "com.friday.bridge"
    private static let nodeService = "bot.molt.node"
    private static let legacyNodeService = "com.friday.node"
