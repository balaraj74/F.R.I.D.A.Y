...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = FRIDAYChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = FRIDAYChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
