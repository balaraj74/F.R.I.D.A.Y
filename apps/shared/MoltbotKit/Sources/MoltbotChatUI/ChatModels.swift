...
public typealias FRIDAYPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias FRIDAYPlatformImage = UIImage
#endif

public struct FRIDAYChatUsageCost: Codable, Hashable, Sendable {
...
public struct FRIDAYChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: FRIDAYChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(FRIDAYChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct FRIDAYChatMessageContent: Codable, Hashable, Sendable {
...
public struct FRIDAYChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [FRIDAYChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: FRIDAYChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [FRIDAYChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: FRIDAYChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(FRIDAYChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([FRIDAYChatMessageContent].self, forKey: .content) {
...
public struct FRIDAYChatHistoryPayload: Codable, Sendable {
...
public struct FRIDAYSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct FRIDAYSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [FRIDAYSessionPreviewItem]
}

public struct FRIDAYSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [FRIDAYSessionPreviewEntry]

    public init(ts: Int, previews: [FRIDAYSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct FRIDAYChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct FRIDAYChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct FRIDAYAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct FRIDAYChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct FRIDAYGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct FRIDAYPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: FRIDAYPlatformImage?
...
public struct FRIDAYChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
