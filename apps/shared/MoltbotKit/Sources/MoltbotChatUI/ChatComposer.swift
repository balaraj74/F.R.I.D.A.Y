...
@MainActor
struct FRIDAYChatComposer: View {
    @Bindable var viewModel: FRIDAYChatViewModel
        ...
        .background {
            ...
            if self.style == .standard {
                let shape = UnevenRoundedRectangle(
                    ...
                    style: .continuous)
                shape
                    .fill(FRIDAYChatTheme.composerBackground)
                    .overlay(shape.strokeBorder(FRIDAYChatTheme.composerBorder, lineWidth: 1))
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 6) {
                ForEach(
                    ...
                    id: \FRIDAYPendingAttachment.id)
                { (att: FRIDAYPendingAttachment) in
                    HStack(spacing: 6) {
                        if let img = att.preview {
                            FRIDAYPlatformImageFactory.image(img)
                                .resizable()
                                .scaledToFill()
    ...
    private var editor: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(FRIDAYChatTheme.composerField)
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .strokeBorder(FRIDAYChatTheme.composerBorder)))
    ...
    private var connectionPill: some View {
        ...
        .padding(.horizontal, 8)
        .padding(.vertical, 4)
        .background(FRIDAYChatTheme.subtleCard)
        .clipShape(Capsule())
    }
