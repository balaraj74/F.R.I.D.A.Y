...
public struct FRIDAYChatView: View {
    ...
    @State private var viewModel: FRIDAYChatViewModel
    ...
    private var visibleMessages: [FRIDAYChatMessage] {
        let base: [FRIDAYChatMessage]
    ...
    private func mergeToolResults(in messages: [FRIDAYChatMessage]) -> [FRIDAYChatMessage] {
    ...
    private func isToolResultMessage(_ message: FRIDAYChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: FRIDAYChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: FRIDAYChatMessage) -> String {
