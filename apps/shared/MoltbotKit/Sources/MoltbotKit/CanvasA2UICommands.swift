...
public enum FRIDAYCanvasA2UICommand: String, Codable, Sendable {
...
public struct FRIDAYCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct FRIDAYCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
