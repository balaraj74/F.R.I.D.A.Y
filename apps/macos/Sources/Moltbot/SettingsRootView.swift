...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .fridaySelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? FRIDAYPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? FRIDAYPaths.stateDirURL.path
...
extension Notification.Name {
    static let fridaySelectSettingsTab = Notification.Name("fridaySelectSettingsTab")
}
