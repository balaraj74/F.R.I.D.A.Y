...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (FRIDAY token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: FRIDAYOAuthStore.AnthropicOAuthStatus = FRIDAYOAuthStore
...
enum FRIDAYOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let fridayOAuthDirEnv = "FRIDAY_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "FRIDAY OAuth token file not found"
            case .unreadableFile: "FRIDAY OAuth token file not readable"
            case .invalidJSON: "FRIDAY OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in FRIDAY OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "FRIDAY OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.fridayOAuthDirEnv]?
