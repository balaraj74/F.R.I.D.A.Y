...
enum FRIDAYLogging {
    ...
    private static let didBootstrap: Void = {
        LoggingSystem.bootstrap { label in
            ...
            let osHandler = FRIDAYOSLogHandler(subsystem: subsystem, category: category)
            let fileHandler = FRIDAYFileLogHandler(label: label)
...
extension Logging.Logger {
    init(subsystem: String, category: String) {
        FRIDAYLogging.bootstrapIfNeeded()
        let label = FRIDAYLogging.makeLabel(subsystem: subsystem, category: category)
...
struct FRIDAYOSLogHandler: LogHandler {
...
struct FRIDAYFileLogHandler: LogHandler {
    let label: String
    var metadata: Logger.Metadata = [:]
        ...
        line: UInt)
    {
        ...
        let (subsystem, category) = FRIDAYLogging.parseLabel(self.label)
