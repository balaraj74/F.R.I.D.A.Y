...
final class PeekabooBridgeHostCoordinator {
    ...
    private var services: FRIDAYPeekabooBridgeServices?
    ...
    private func startIfNeeded() async {
        ...
        let services = FRIDAYPeekabooBridgeServices()
        ...
        let host = PeekabooBridgeHost(
            socketPath: PeekabooBridgeConstants.fridaySocketPath,
            server: server,
        ...
        await host.start()
        self.logger
            .info("PeekabooBridge host started at \(PeekabooBridgeConstants.fridaySocketPath, privacy: .public)")
    }
...
@MainActor
private final class FRIDAYPeekabooBridgeServices: PeekabooBridgeServiceProviding {
