...
enum UIStrings {
    static let welcomeTitle = "Welcome to FRIDAY"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: FRIDAYOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: FRIDAYChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g friday@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: FRIDAYChatViewModel(
