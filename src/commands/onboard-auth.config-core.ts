...
export function applyZaiConfig(cfg: FRIDAYConfig): FRIDAYConfig {
...
export function applyOpenrouterProviderConfig(cfg: FRIDAYConfig): FRIDAYConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: FRIDAYConfig): FRIDAYConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: FRIDAYConfig): FRIDAYConfig {
...
export function applyOpenrouterConfig(cfg: FRIDAYConfig): FRIDAYConfig {
...
export function applyMoonshotProviderConfig(cfg: FRIDAYConfig): FRIDAYConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: FRIDAYConfig): FRIDAYConfig {
...
export function applyKimiCodeProviderConfig(cfg: FRIDAYConfig): FRIDAYConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: FRIDAYConfig): FRIDAYConfig {
...
export function applySyntheticProviderConfig(cfg: FRIDAYConfig): FRIDAYConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: FRIDAYConfig): FRIDAYConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: FRIDAYConfig): FRIDAYConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: FRIDAYConfig): FRIDAYConfig {
