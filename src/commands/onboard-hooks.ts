...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.friday.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("friday hooks list")}`,
      `  ${formatCliCommand("friday hooks enable <name>")}`,
      `  ${formatCliCommand("friday hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
