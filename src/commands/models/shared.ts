...
import { type FRIDAYConfig, readConfigFileSnapshot, writeConfigFile } from "../../config/config.js";
...
export async function updateConfig(
  mutator: (cfg: FRIDAYConfig) => FRIDAYConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: FRIDAYConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: FRIDAYConfig): Set<string> {
