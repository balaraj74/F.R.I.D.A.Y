...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "friday-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<FRIDAYConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<FRIDAYConfig["telegram"]>>,
