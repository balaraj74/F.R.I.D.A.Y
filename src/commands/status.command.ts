...
export async function statusCommand(
  ...
  runtime.log(theme.heading("FRIDAY status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("friday security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("friday security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.friday.ai/faq");
  runtime.log("Troubleshooting: https://docs.friday.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("friday status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("friday logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("friday status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("friday gateway probe")}`);
  }
}
