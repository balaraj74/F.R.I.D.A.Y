...
export const PLUGIN_MANIFEST_FILENAME = "friday.plugin.json";
...
// package.json "friday" metadata (used for onboarding/catalog)
...
export type FRIDAYPackageManifest = {
  extensions?: string[];
...
): FRIDAYPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.friday ?? manifest[LEGACY_MANIFEST_KEY];
}
