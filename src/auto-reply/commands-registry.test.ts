...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@friday", { botUsername: "friday" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@friday args", {
        botUsername: "friday",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "friday" })).toBe(
      "/help@otherbot",
    );
  });
