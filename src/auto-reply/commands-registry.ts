import type { FRIDAYConfig } from "../config/types.js";
...
export function isCommandEnabled(cfg: FRIDAYConfig, commandKey: string): boolean {
...
function resolveDefaultCommandContext(cfg?: FRIDAYConfig): {
  provider: string;
  model: string;
} {
...
export function getCommandDetection(_cfg?: FRIDAYConfig): CommandDetection {
  const commands = getChatCommands();
...
export function maybeResolveTextAlias(raw: string, cfg?: FRIDAYConfig) {
