...
export const A2UI_PATH = "/__friday__/a2ui";
export const CANVAS_HOST_PATH = "/__friday__/canvas";
export const CANVAS_WS_PATH = "/__friday/ws";
...
(() => {
  ...
  const handlerNames = ["fridayCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.FRIDAY = globalThis.FRIDAY ?? {};
  globalThis.FRIDAY.postMessage = postToNode;
  globalThis.FRIDAY.sendUserAction = sendUserAction;
  globalThis.fridayPostMessage = postToNode;
  globalThis.fridaySendUserAction = sendUserAction;
  globalThis.fridayPostMessage = postToNode;
  globalThis.fridaySendUserAction = sendUserAction;
