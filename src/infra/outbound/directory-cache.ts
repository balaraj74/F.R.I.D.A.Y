...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: FRIDAYConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: FRIDAYConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: FRIDAYConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: FRIDAYConfig): void {
    this.cache.clear();
    if (cfg) this.lastConfigRef = cfg;
  }

  private resetIfConfigChanged(cfg: FRIDAYConfig): void {
