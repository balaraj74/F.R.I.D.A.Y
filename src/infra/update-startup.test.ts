...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "friday-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveFRIDAYPackageRoot } = await import("./friday-root.js");
    ...
    vi.mocked(resolveFRIDAYPackageRoot).mockResolvedValue("/opt/friday");
