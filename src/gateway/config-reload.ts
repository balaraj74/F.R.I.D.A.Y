...
import type { FRIDAYConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: FRIDAYConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: FRIDAYConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: FRIDAYConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: FRIDAYConfig) => void;
  log: {
