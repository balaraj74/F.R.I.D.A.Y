...
import { type FRIDAYConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: FRIDAYConfig): string[] {
...
export function listAgentsForGateway(cfg: FRIDAYConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: FRIDAYConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: FRIDAYConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: FRIDAYConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: FRIDAYConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: FRIDAYConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: FRIDAYConfig): GatewaySessionsDefaults {
