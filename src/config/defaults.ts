...
function resolveAnthropicDefaultAuthMode(cfg: FRIDAYConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: FRIDAYConfig): FRIDAYConfig {
...
export function applyTalkApiKey(config: FRIDAYConfig): FRIDAYConfig {
...
export function applyModelDefaults(cfg: FRIDAYConfig): FRIDAYConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: FRIDAYConfig): FRIDAYConfig {
...
export function applyLoggingDefaults(cfg: FRIDAYConfig): FRIDAYConfig {
...
export function applyContextPruningDefaults(cfg: FRIDAYConfig): FRIDAYConfig {
...
export function applyCompactionDefaults(cfg: FRIDAYConfig): FRIDAYConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
