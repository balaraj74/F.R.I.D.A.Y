...
function isTelegramConfigured(cfg: FRIDAYConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: FRIDAYConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: FRIDAYConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: FRIDAYConfig): boolean {
...
function isIMessageConfigured(cfg: FRIDAYConfig): boolean {
...
function isWhatsAppConfigured(cfg: FRIDAYConfig): boolean {
...
function isGenericChannelConfigured(cfg: FRIDAYConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: FRIDAYConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: FRIDAYConfig, providerId: string): boolean {
...
function resolveConfiguredPlugins(cfg: FRIDAYConfig, env: NodeJS.ProcessEnv): PluginEnableChange[] {
...
function isPluginExplicitlyDisabled(cfg: FRIDAYConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: FRIDAYConfig, pluginId: string): boolean {
...
function enablePluginEntry(cfg: FRIDAYConfig, pluginId: string): FRIDAYConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
