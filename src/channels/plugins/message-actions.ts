...
export function listChannelMessageActions(cfg: FRIDAYConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: FRIDAYConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: FRIDAYConfig): boolean {
  for (const plugin of listChannelPlugins()) {
