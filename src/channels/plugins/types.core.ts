...
export type ChannelAgentToolFactory = (params: { cfg?: FRIDAYConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: FRIDAYConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: FRIDAYConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: FRIDAYConfig }) => boolean;
  supportsCards?: (params: { cfg: FRIDAYConfig }) => boolean;
