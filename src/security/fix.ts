...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof FRIDAYConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: FRIDAYConfig; env: NodeJS.ProcessEnv }): {
  cfg: FRIDAYConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
