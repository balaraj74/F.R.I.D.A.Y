...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.FRIDAY_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: FRIDAYConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: FRIDAYConfig): string {
...
function mergeTelegramAccountConfig(cfg: FRIDAYConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: FRIDAYConfig): ResolvedTelegramAccount[] {
