...
export function listBindings(cfg: FRIDAYConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: FRIDAYConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: FRIDAYConfig) {
