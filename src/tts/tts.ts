...
export function resolveTtsConfig(cfg: FRIDAYConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.FRIDAY_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: FRIDAYConfig): string | undefined {
