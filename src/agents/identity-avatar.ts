...
function resolveAvatarSource(cfg: FRIDAYConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: FRIDAYConfig, agentId: string): AgentAvatarResolution {
