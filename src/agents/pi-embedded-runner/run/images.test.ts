...
[media attached 1/2: /Users/tyleryust/.friday/media/IMG_6430.jpeg (image/jpeg)]
[media attached 2/2: /Users/tyleryust/.friday/media/IMG_6431.jpeg (image/jpeg)]
...
what is this?`;
  ...
  it("handles paths with spaces in filename", () => {
    ...
    const prompt = `[media attached: /Users/test/.friday/media/ChatGPT Image Apr 21, 2025.png (image/png) | https://example.com/same.png]
what is this?`;
    const refs = detectImageReferences(prompt);
