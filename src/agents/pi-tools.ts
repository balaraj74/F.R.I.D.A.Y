...
function resolveExecConfig(cfg: FRIDAYConfig | undefined) {
...
export function createFRIDAYCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createFRIDAYReadTool(freshReadTool)];
    }
