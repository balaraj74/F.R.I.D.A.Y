...
describe("createFRIDAYCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createFRIDAYCodingTools({
      config,
    ...
    const anthropicTools = createFRIDAYCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createFRIDAYCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createFRIDAYCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
