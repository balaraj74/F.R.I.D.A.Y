...
function resolveMainSessionKeyForSandbox(params: { cfg?: FRIDAYConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: FRIDAYConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`friday sandbox explain --session ${runtime.sessionKey}`)}`,
  );
