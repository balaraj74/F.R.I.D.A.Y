...
function resolveWatchPaths(workspaceDir: string, config?: FRIDAYConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: FRIDAYConfig }) {
