...
import type { FRIDAYConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: FRIDAYConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: FRIDAYConfig | undefined, pathStr: string): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "friday-bundled";
}

export function resolveBundledAllowlist(config?: FRIDAYConfig): string[] | undefined {
