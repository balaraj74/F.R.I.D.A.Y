  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "friday.sandbox=1",
        "--label",
        "friday.sessionKey=main",
        "--label",
        "friday.createdAtMs=1700000000000",
        "--label",
        "friday.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
