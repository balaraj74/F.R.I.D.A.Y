...
describe("Agent-specific tool filtering", () => {
  it("should apply global tool policy when no agent-specific policy exists", () => {
    ...
    const tools = createFRIDAYCodingTools({
      config: cfg,
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createFRIDAYCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createFRIDAYCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createFRIDAYCodingTools({
      config: cfg,
    ...
    const defaultTools = createFRIDAYCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createFRIDAYCodingTools({
      config: cfg,
    ...
    const bobTools = createFRIDAYCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createFRIDAYCodingTools({
      config: cfg,
