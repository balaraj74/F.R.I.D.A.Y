...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies FRIDAYConfig;

const _ensureModels = (cfg: FRIDAYConfig, agentDir: string) =>
  ensureFRIDAYModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/friday-sandbox",
      agentWorkspaceDir: "/tmp/friday-workspace",
      ...
      browser: {
        ...
        containerName: "friday-sbx-browser-test",
      },
