...
const SANDBOX_EXAMPLES = {
  main: [
    ["friday sandbox list", "List all sandbox containers."],
    ["friday sandbox list --browser", "List only browser containers."],
    ["friday sandbox recreate --all", "Recreate all containers."],
    ["friday sandbox recreate --session main", "Recreate a specific session."],
    ["friday sandbox recreate --agent mybot", "Recreate agent containers."],
    ["friday sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["friday sandbox list", "List all sandbox containers."],
    ["friday sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["friday sandbox recreate --all", "Recreate all containers."],
    ["friday sandbox recreate --session main", "Recreate a specific session."],
    ["friday sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["friday sandbox recreate --browser --all", "Recreate only browser containers."],
    ["friday sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["friday sandbox explain", "Show effective sandbox config."],
    ["friday sandbox explain --session agent:main:main", "Explain a specific session."],
    ["friday sandbox explain --agent work", "Explain an agent sandbox."],
    ["friday sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.friday.ai/cli/sandbox")}\n`,
    )
    .action(() => {
