...
export function buildServiceEnvironment(params: {
  ...
  return {
    ...
    FRIDAY_PROFILE: profile,
    FRIDAY_STATE_DIR: env.FRIDAY_STATE_DIR,
    FRIDAY_CONFIG_PATH: env.FRIDAY_CONFIG_PATH,
    FRIDAY_GATEWAY_PORT: String(port),
    FRIDAY_GATEWAY_TOKEN: token,
    FRIDAY_LAUNCHD_LABEL: resolvedLaunchdLabel,
    FRIDAY_SYSTEMD_UNIT: systemdUnit,
    FRIDAY_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    FRIDAY_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    FRIDAY_STATE_DIR: env.FRIDAY_STATE_DIR,
    FRIDAY_CONFIG_PATH: env.FRIDAY_CONFIG_PATH,
    FRIDAY_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    FRIDAY_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    FRIDAY_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    FRIDAY_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    FRIDAY_LOG_PREFIX: "node",
    FRIDAY_SERVICE_MARKER: NODE_SERVICE_MARKER,
    FRIDAY_SERVICE_KIND: NODE_SERVICE_KIND,
    FRIDAY_SERVICE_VERSION: VERSION,
  };
}
