...
### Changes
- Version alignment with core FRIDAY release numbers.
...
### Highlights
- First public release of the @friday/voice-call plugin.
...
- CLI: `friday voicecall` commands (call/start/continue/speak/end/status/tail/expose).
