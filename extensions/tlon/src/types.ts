...
export function resolveTlonAccount(cfg: FRIDAYConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: FRIDAYConfig): string[] {
  const base = cfg.channels?.tlon as
