...
import { removeAckReactionAfterReply, shouldAckReaction } from "friday/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/friday") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
