...
- Install via CLI: `friday plugins install @friday/zalo`
- Or select **Zalo** during onboarding and confirm the install prompt
- Details: [Plugins](/plugin)

## Quick setup (beginner)
1) Install the Zalo plugin:
   - From a source checkout: `friday plugins install ./extensions/zalo`
   - From npm (if published): `friday plugins install @friday/zalo`
...
- Approve via:
  - `friday pairing list zalo`
  - `friday pairing approve zalo <CODE>`
...
- Example: `friday message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**
- Check that the token is valid: `friday channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `friday logs --follow`
