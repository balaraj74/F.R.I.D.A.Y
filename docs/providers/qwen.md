---
summary: "Use Qwen OAuth (free tier) in FRIDAY"
read_when:
  - You want to use Qwen with FRIDAY
...
```bash
friday models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, FRIDAY will sync credentials
