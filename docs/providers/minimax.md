---
summary: "Use MiniMax M2.1 in FRIDAY"
read_when:
  - You want MiniMax models in FRIDAY
...
Configure manually via `friday.json`:
...
- Use `friday models list` and `friday models set minimax/MiniMax-M2.1` to switch.
...
- Running `friday configure` and selecting **MiniMax M2.1**, or
