...
You can point FRIDAY at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or FRIDAY
...
- [Anthropic provider](/providers/anthropic) - Native FRIDAY integration with Claude setup-token or API keys
