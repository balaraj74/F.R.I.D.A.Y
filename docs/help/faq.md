---
summary: "Frequently asked questions about FRIDAY setup, configuration, and usage"
---
# FAQ
...
- [Quick start and first-run setup](#quick-start-and-firstrun-setup)
  ...
  - [What’s the recommended way to install and set up FRIDAY?](#whats-the-recommended-way-to-install-and-set-up-friday)
  ...
  - [I can't access docs.friday.ai (SSL error). What now?](#i-cant-access-docsfriday-ssl-error-what-now)
  - [What’s the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
- [How do I install the beta version, and what’s the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or friday not recognized](#windows-install-says-git-not-found-or-friday-not-recognized)
  - [The docs didn’t answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install FRIDAY on Linux?](#how-do-i-install-friday-on-linux)
  - [How do I install FRIDAY on a VPS?](#how-do-i-install-friday-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Clawd to update itself?](#can-i-ask-friday-to-update-itself)
  ...
  - [If I buy a Mac mini to run FRIDAY, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-friday-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different FRIDAYs?](#can-multiple-people-use-one-whatsapp-number-with-different-fridays)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What’s the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run FRIDAY on a dedicated machine?](#how-important-is-it-to-run-friday-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run FRIDAY in a VM and what are the requirements](#can-i-run-friday-in-a-vm-and-what-are-the-requirements)
- [What is FRIDAY?](#what-is-friday)
  - [What is FRIDAY, in one paragraph?](#what-is-friday-in-one-paragraph)
  - [What’s the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for FRIDAY](#what-are-the-top-five-everyday-use-cases-for-friday)
  - [Can FRIDAY help with lead gen outreach ads and blogs for a SaaS](#can-friday-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can FRIDAY run tasks on a schedule or continuously in the background?](#can-friday-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with FRIDAY saved locally?](#is-all-data-used-with-friday-saved-locally)
  - [Where does FRIDAY store its data?](#where-does-friday-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What’s the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall FRIDAY?](#how-do-i-completely-uninstall-friday)
...
- [Config basics](#config-basics)
  ...
  - [Can the FRIDAY browser run headless?](#can-the-friday-browser-run-headless)
...
- [Remote gateways + nodes](#remote-gateways-nodes)
  ...
  - [Can two FRIDAYs talk to each other (local + VPS)?](#can-two-fridays-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does FRIDAY load environment variables?](#how-does-friday-load-environment-variables)
...
- [Sessions & multiple chats](#sessions-multiple-chats)
  ...
  - [Is there a way to make a team of FRIDAYs one CEO and many agents](#is-there-a-way-to-make-a-team-of-fridays-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset FRIDAY but keep it installed?](#how-do-i-completely-reset-friday-but-keep-it-installed)
  ...
  - [Why doesn’t FRIDAY reply in a group?](#why-doesnt-friday-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Clawd, Flawd, and Krill use for models?](#what-do-friday-flawd-and-krill-use-for-models)
...
- [Gateway: ports, “already running”, and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `friday gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-friday-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `friday gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-friday-gateway-status-show-config-cli-and-config-service-different)
  - [What does “another gateway instance is already listening” mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run FRIDAY in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-friday-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart FRIDAY?](#i-closed-my-terminal-on-windows-how-do-i-restart-friday)
  ...
  - [ELI5: `friday gateway restart` vs `friday gateway`](#eli5-friday-gateway-restart-vs-friday-gateway)
  - [What’s the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media & attachments](#media-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose FRIDAY to inbound DMs?](#is-it-safe-to-expose-friday-to-inbound-dms)
...
5) **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/friday/friday-*.log | head -1)"
   ```
...
7) **Gateway snapshot**
   ```bash
   friday health --json
   friday health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://friday.ai/install.sh | bash -s -- --install-method git
```

This installs FRIDAY **from a git checkout**, so the agent can read the code + docs and
...
https://github.com/friday/friday/issues
https://github.com/friday/friday/pulls

Start with these commands (share outputs when asking for help):

```bash
friday status
friday models status
friday doctor
```

What they do:
- `friday status`: quick snapshot of gateway/agent health + basic config.
- `friday models status`: checks provider auth + model availability.
- `friday doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `friday status --all`, `friday logs --follow`,
`friday gateway status`, `friday health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### Whats the recommended way to install and set up FRIDAY

The repo recommends running from source and using the onboarding wizard:

```bash
curl -fsSL https://friday.ai/install.sh | bash
...
If you don’t have a global install yet, run it via `pnpm friday onboard`.
...
- If it asks for auth, run `friday dashboard` and use the tokenized link (`?token=...`).
- The token is the same value as `gateway.auth.token` (or `FRIDAY_GATEWAY_TOKEN`) and is stored by the UI after first load.

**Not on localhost:**
- **Tailscale Serve** (recommended): keep bind loopback, run `friday gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `friday gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
- **SSH tunnel**: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...` from `friday dashboard`.
...
1) Install FRIDAY on the new machine.
2) Copy `$FRIDAY_STATE_DIR` (default: `~/.friday`) from the old machine.
3) Copy your workspace (default: `~/friday`).
4) Run `friday doctor` and restart the Gateway service.
...
under `~/.friday/` (for example `~/.friday/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-friday-store-its-data),
...
https://github.com/friday/friday/blob/main/CHANGELOG.md

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docsfriday SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.friday.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.friday.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsfriday-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: https://spa.xfinity.com/check_url_status.

If you still can't reach the site, the docs are mirrored on GitHub:
https://github.com/friday/friday/tree/main/docs
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://friday.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://friday.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
https://friday.ai/install.ps1
...
```bash
curl -fsSL https://friday.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://friday.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://friday.ai/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or friday not recognized
...
**2) friday is not recognized after install**
...
### How do I install FRIDAY on Linux
...
### How do I install FRIDAY on a VPS
...
friday update --channel stable|beta|dev
friday update --tag <dist-tag|version>
friday update --no-restart
```

If you must automate from an agent:

```bash
friday update --yes --no-restart
friday gateway restart
```
...
`friday onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run FRIDAY with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `friday models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `friday models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `friday models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro/Max)

Yes — via **setup-token**. FRIDAY no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so FRIDAY can keep replying while a provider is rate‑limited.
...
FRIDAY supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.2` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. FRIDAY fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `friday.json`.

Steps:
1) Enable the plugin: `friday plugins enable google-gemini-cli-auth`
2) Login: `friday models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. FRIDAY needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. FRIDAY runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
any Mac works. FRIDAY’s iMessage integrations run on macOS (BlueBubbles or `imsg`), while
...
### If I buy a Mac mini to run FRIDAY can I connect it to my MacBook Pro
...
- Use `friday nodes status` / `friday nodes list` to see it.
...
- DM your bot, then run `friday logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different FRIDAYs
...
If you run FRIDAY via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non‑login shells.
...
This **does not delete your data** - it only changes the FRIDAY code install. Your state
(`~/.friday`) and workspace (`~/friday`) stay untouched.
...
**FRIDAY-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you’re actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run FRIDAY on a dedicated machine
...
FRIDAY is lightweight. For a basic Gateway + one chat channel:
...
### Can I run FRIDAY in a VM and what are the requirements
...
### What is FRIDAY in one paragraph

FRIDAY is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### Whats the value proposition

FRIDAY is not “just a Claude wrapper.” It’s a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for FRIDAY
...
### Can FRIDAY help with lead gen outreach ads and blogs for a SaaS
...
FRIDAY draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

FRIDAY is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use FRIDAY when you
...
Showcase: https://friday.ai/showcase

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.friday/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.friday/friday.json`). Precedence is `<workspace>/skills` > `~/.friday/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.friday/friday.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.friday/skills` → bundled → `skills.load.extraDirs`. `fridayhub` installs into `./skills` by default, which FRIDAY treats as `<workspace>/skills`.
...
Checklist:
- Confirm cron is enabled (`cron.enabled`) and `FRIDAY_SKIP_CRON` is not set.
- Check the Gateway is running 24/7 (no sleep/restarts).
- Verify timezone settings for the job (`--tz` vs host timezone).

Debug:
```bash
friday cron run <jobId> --force
friday cron runs --id <jobId> --limit 50
```
...
Browse skills at https://fridayhub.com.
...
```bash
pnpm add -g fridayhub
```

### Can FRIDAY run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.friday.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `imsg`, `apple-notes`, `apple-reminders`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**  
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-friday-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**  
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. FRIDAY can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3) Override the skill metadata (workspace or `~/.friday/skills`) to allow Linux:
   ```markdown
   ---
   name: imsg
   description: iMessage/SMS CLI for listing chats, history, watch, and sending.
   metadata: {"friday":{"os":["darwin","linux"],"requires":{"bins":["imsg"]}}}
   ---
   ```
4) Start a new session so the skills snapshot refreshes.

For iMessage specifically, you can also point `channels.imessage.cliPath` at an SSH wrapper (FRIDAY only needs stdio). See [iMessage](/channels/imessage).
...
```bash
fridayhub install <skill-slug>
fridayhub update --all
```

ClawdHub installs into `./skills` under your current directory (or falls back to your configured FRIDAY workspace); FRIDAY treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.friday/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawdHub](/tools/fridayhub).
...
```bash
friday browser extension install
friday browser extension path
```
...
FRIDAY memory is just Markdown files in the agent workspace:
- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

FRIDAY also runs a **silent pre-compaction memory flush** to remind the model
...
If you don’t set a provider explicitly, FRIDAY auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, FRIDAY
prefers `local`.
...
### Is all data used with FRIDAY saved locally

No - **FRIDAY’s state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.friday` + your workspace directory).
...
### Where does FRIDAY store its data

Everything lives under `$FRIDAY_STATE_DIR` (default: `~/.friday`):

| Path | Purpose |
|------|---------|
| `$FRIDAY_STATE_DIR/friday.json` | Main config (JSON5) |
| `$FRIDAY_STATE_DIR/credentials/oauth.json` | Legacy OAuth import (copied into auth profiles on first use) |
| `$FRIDAY_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys) |
| `$FRIDAY_STATE_DIR/agents/<agentId>/agent/auth.json` | Runtime auth cache (managed automatically) |
| `$FRIDAY_STATE_DIR/credentials/` | Provider state (e.g. `whatsapp/<accountId>/creds.json`) |
| `$FRIDAY_STATE_DIR/agents/` | Per‑agent state (agentDir + sessions) |
| `$FRIDAY_STATE_DIR/agents/<agentId>/sessions/` | Conversation history & state (per agent) |
| `$FRIDAY_STATE_DIR/agents/<agentId>/sessions/sessions.json` | Session metadata (per agent) |

Legacy single‑agent path: `~/.friday/agent/*` (migrated by `friday doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/friday`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.friday`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.friday`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.friday/skills`).

Default workspace is `~/friday`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/friday" } }
}
```
...
Do **not** commit anything under `~/.friday` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall FRIDAY
...
`workspace` to the repo root. The FRIDAY repo is just source code; keep the
...
FRIDAY reads an optional **JSON5** config from `$FRIDAY_CONFIG_PATH` (default: `~/.friday/friday.json`):

```
$FRIDAY_CONFIG_PATH
```

If the file is missing, it uses safe‑ish defaults (including a default workspace of `~/friday`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `FRIDAY_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `friday doctor --generate-gateway-token`.
...
key. **Recommended:** run `friday configure --section web` to store it in
...
- Daemons read env vars from `~/.friday/.env` (or the service environment).
...
### Can the FRIDAY browser run headless
...
5) Approve the node on the Gateway:
   ```bash
   friday nodes pending
   friday nodes approve <requestId>
   ```
...
Check the basics:
- Gateway is running: `friday gateway status`
- Gateway health: `friday status`
- Channel health: `friday channels status`
...
### Can two FRIDAYs talk to each other local VPS
...
`friday agent --message ... --deliver`, targeting a chat where the other bot
listens. If one bot is on a remote VPS, point your CLI at that remote Gateway
via SSH/Tailscale (see [Remote access](/gateway/remote)).

Example pattern (run from a machine that can reach the target Gateway):
```bash
friday agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
Recover:
- Restore from backup (git or a copied `~/.friday/friday.json`).
- If you have no backup, re-run `friday doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:
- Use `friday config set` for small changes.
- Use `friday configure` for interactive edits.
...
```bash
friday gateway --tailscale serve
```
...
### How does FRIDAY load environment variables

FRIDAY reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.friday/.env` (aka `$FRIDAY_STATE_DIR/.env`)
...
1) Put the missing keys in `~/.friday/.env` so they’re picked up even when the service doesn’t inherit your shell env.
...
`FRIDAY_LOAD_SHELL_ENV=1`, `FRIDAY_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`friday models status` reports whether **shell env import** is enabled. “Shell env: off”
does **not** mean your env vars are missing - it just means FRIDAY won’t load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won’t inherit your shell
environment. Fix by doing one of these:

1) Put the token in `~/.friday/.env`:
   ```
...
### Is there a way to make a team of FRIDAYs one CEO and many agents
...
### How do I completely reset FRIDAY but keep it installed
...
```bash
friday reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `FRIDAY_PROFILE`), reset each state dir (defaults are `~/.friday-<profile>`).
- Dev reset: `friday gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), FRIDAY skips the heartbeat run to save API calls.
...
No. FRIDAY runs on **your own account**, so if you’re in the group, FRIDAY can see it.
...
```bash
friday directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt FRIDAY reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.friday/agents/<agentId>/sessions/`.
...
- Use `friday doctor` to spot stray workspaces and profile mismatches.
...
FRIDAY’s default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-5`). If you omit the provider, FRIDAY currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `friday models set ...` (updates just model config)
- `friday configure --section models` (interactive)
- edit `agents.defaults.model` in `~/.friday/friday.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `friday doctor` to repair.
...
Yes. FRIDAY ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.friday/agents/<agentId>/agent/auth-profiles.json
```

Fix options:
- Run `friday agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so FRIDAY can keep responding even when a provider is rate‑limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.friday/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.friday/agent/*` (migrated by `friday doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.friday/.env` or enable `env.shellEnv`.
- **Make sure you’re editing the correct agent**
  - Multi‑agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity‑check model/auth status**
  - Use `friday models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `friday models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `friday models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.friday/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:
    ```bash
    friday models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), FRIDAY will try it during model fallback. If you haven’t configured Google credentials, you’ll see `No API key found for provider "google"`.
...
Fix: FRIDAY now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
FRIDAY uses provider‑prefixed IDs like:
...
FRIDAY may temporarily skip a profile if it’s in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `friday models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent’s `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
friday models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
friday models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
friday models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
friday models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

FRIDAY supports both:
...
```
--port > FRIDAY_GATEWAY_PORT > gateway.port > default 18789
```

### Why does friday gateway status say Runtime running but RPC probe failed

Because “running” is the **supervisor’s** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `friday gateway status` and trust these lines:
- `Probe target:` (the URL the probe actually used)
- `Listening:` (what’s actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn’t listening)

### Why does friday gateway status show Config cli and Config service different

You’re editing one config file while the service is running another (often a `--profile` / `FRIDAY_STATE_DIR` mismatch).

Fix:
```bash
friday gateway install --force
```
Run that from the same `--profile` / environment you want the service to use.

### What does another gateway instance is already listening mean

FRIDAY enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `friday gateway --port <port>`.

### How do I run FRIDAY in remote mode client connects to a Gateway elsewhere
...
Notes:
- `friday gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
Facts (from code):
- The Control UI stores the token in browser localStorage key `friday.control.settings.v1`.
- The UI can import `?token=...` (and/or `?password=...`) once, then strips it from the URL.

Fix:
- Fastest: `friday dashboard` (prints + copies tokenized link, tries to open; shows SSH hint if headless).
- If you don’t have a token yet: `friday doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/?token=...`.
- Set `gateway.auth.token` (or `FRIDAY_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token (or refresh with a one-time `?token=...` link).
- Still stuck? Run `friday status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `FRIDAY_CONFIG_PATH` (per‑instance config)
- `FRIDAY_STATE_DIR` (per‑instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):
- Use `friday --profile <name> …` per instance (auto-creates `~/.friday-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `friday --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.friday.*`, `friday-gateway-<profile>.service`, `FRIDAY Gateway (<profile>)`).
...
```
friday tui --url ws://<host>:18789 --token <token>
```
...
- macOS: `$FRIDAY_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.friday/logs/...`; profiles use `~/.friday-<profile>/logs/...`)
- Linux: `journalctl --user -u friday-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "FRIDAY Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `friday gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart FRIDAY
...
1) Is the Gateway running? `friday gateway status`
2) Is the Gateway healthy? `friday status`
3) Does the UI have the right token? `friday dashboard`
...
```bash
friday channels status
friday channels logs --channel telegram
```
...
### ELI5 friday gateway restart vs friday gateway

- `friday gateway restart`: restarts the **background service** (launchd/systemd).
- `friday gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `friday gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [FRIDAY assistant setup](/start/friday) and [Agent send](/tools/agent-send).

CLI sending:

```bash
friday message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose FRIDAY to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM‑capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `friday pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `friday pairing list <channel>` if a code didn’t arrive.
- Opening DMs publicly requires explicit opt‑in (`dmPolicy: "open"` and allowlist `"*"`).

Run `friday doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. FRIDAY only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
friday pairing approve whatsapp <code>
```

List pending requests:

```bash
friday pairing list whatsapp
```
...
FRIDAY blocks **cross‑provider** messaging by default. If a tool call is bound
...
**A:** In FRIDAY, credentials and model selection are separate. Setting `ANTHROPIC_API_KEY` (or storing an Anthropic API key in auth profiles) enables authentication, but the actual default model is whatever you configure in `agents.defaults.model.primary` (for example, `anthropic/claude-sonnet-4-5` or `anthropic/claude-opus-4-5`). If you see `No credentials found for profile "anthropic:default"`, it means the Gateway couldn’t find Anthropic credentials in the expected `auth-profiles.json` for the agent that’s running.

---

Still stuck? Ask in [Discord](https://discord.com/invite/friday) or open a [GitHub discussion](https://github.com/friday/friday/discussions).
