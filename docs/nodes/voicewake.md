...
FRIDAY treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.friday/settings/voicewake.json`

Shape:

```json
{ "triggers": ["friday", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
