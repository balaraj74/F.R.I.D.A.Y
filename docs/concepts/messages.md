...
This page ties together how FRIDAY handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. FRIDAY keeps a
...
FRIDAY separates the **prompt body** from the **command body**:
...
FRIDAY can expose or hide model reasoning:
