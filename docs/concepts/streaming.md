...
FRIDAY has two separate “streaming” layers:
...
When block streaming is enabled, FRIDAY can **merge consecutive block chunks**
...
When draft streaming is active, FRIDAY disables block streaming for that reply to avoid double-streaming.
